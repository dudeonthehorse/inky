...
module.exports = function(element) {
	...
	switch (element[0].name) {
		...
		case this.components.button:
			...
			border = (element.attr('width'));

			return format('<table width="' + width + '" class="%s"><tr><td align="center" style="border-radius:' + radius + ';" bgcolor="' + bgcolor + '; border:' + border + ';">%s</td></tr></table>', classes.join(' '), inner);
